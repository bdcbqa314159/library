...
private:
    ...
    void remove(const t_Data &data, std::unique_ptr<Node> &nodeRef)
    {
        ...
        else
        {
            ...
            {
                std::cout << "Removing a leaf node..." << std::endl;
                nodeRef.reset();
                return;
            }
            ...
            if (!nodeRef->left)
            {
                std::cout << "Removing the first right child" << std::endl;
            ...
            {
                std::cout << "Removing the first left child" << std::endl;
                std::unique_ptr<Node> temp = std::move(nodeRef->left);
                nodeRef.reset();
                nodeRef = std::move(temp);
                return;
            }
            std::cout << "Removing item with two children..." << std::endl;
