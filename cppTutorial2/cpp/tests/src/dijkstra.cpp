...
int main()
{
    vector<shared_ptr<dijkstra::Vertex>> vertexList;
    vertexList.push_back(make_shared<dijkstra::Vertex>("A"));
    vertexList.push_back(make_shared<dijkstra::Vertex>("B"));
    vertexList.push_back(make_shared<dijkstra::Vertex>("C"));
    vertexList.push_back(make_shared<dijkstra::Vertex>("D"));
    vertexList.push_back(make_shared<dijkstra::Vertex>("E"));
    vertexList.push_back(make_shared<dijkstra::Vertex>("F"));
    vertexList.push_back(make_shared<dijkstra::Vertex>("G"));
    vertexList.push_back(make_shared<dijkstra::Vertex>("H"));
